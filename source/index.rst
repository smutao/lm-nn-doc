...
[2026-01-26] LModeA-nano was employed by Prof. Lei Chen’s research group to calculate local mode force constants and quantify alkylamine-induced changes in the intrinsic strength of surface Si–Si bonds, revealing that short-chain alkylamines weaken Si–Si bonds more effectively, while long-chain alkylamines exhibit stronger adsorption but milder bond weakening, in their work titled **Atomic Insights of Material Removal Mechanism in Chemical Mechanical Polishing for Silicon Using Developed Abrasive-Free Slurry** published in *Friction*.
